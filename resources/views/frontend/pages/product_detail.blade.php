														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Bạn cần phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('register.form')}}">Register</a>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec">Giảm tới {{$data->discount}} %</span>
