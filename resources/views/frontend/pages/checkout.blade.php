                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <input name="payment_method"  type="radio" value="atm"> <label>ATM(Sẽ cập nhật sau)</label> 
                                            </form-group>
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn">Kiểm tra thanh toán</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
