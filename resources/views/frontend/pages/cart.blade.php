								...
								@else 
										<tr>
											<td class="text-center">
												Không có sản phẩm nào trong giỏ hàng. <a href="{{route('product-grids')}}" style="color:blue;">Continue shopping</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn trả<span>{{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Bạn trả<span>{{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-peragraph">
                                        <p>Shop tư vấn nhiệt tình, sản phẩm đúng như quảng cáo.</p>
                                    </div>
									<div class="size">
										<div class="row">
