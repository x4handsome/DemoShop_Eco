                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html">Lưới</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="single-widget category">
                                    <h3 class="title">Loại mặt hàng</h3>
                                ...
                                <!-- Shop By Price -->
                                    <div class="single-widget range">
                                        <h3 class="title">Xếp theo giá</h3>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                ...
                                @endforeach
                            @else
                                    <h4 class="text-warning" style="margin:100px auto;">Không có sản phẩm nào ở đây.</h4>
                            @endif
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                ...
                                                <div class="quickview-stock">
                                                    @if($product->stock >0)
                                                    <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} còn trong kho</span>
                                                    @else 
